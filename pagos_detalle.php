...
$query_busqueda_alumno = "SELECT * FROM `colegiaturas` WHERE id_alumno='".$buscar_alumnos."' AND ciclo='2025-2026';";
...
<form action="proc_abonar_colegiatura.php" method="POST">
									<thead>
										...
										<tr>
											...
											Alumno(a): <?php echo $nombre_com.' Grupo - '.$grupo; ?></th>
											</tr>
								...
								Monto</th>
										...
										<tr>
											...
											<th class="text-center">&nbsp;</th>
											<th class="text-center"><span style="background-color: #FFC107">
							...
							<select id="miCombobox5" name="txt_mes" style="font-weight: 700">
								...
								<option value="Agosto">Agosto</option>
											...
											<select id="miCombobox7" name="txt_ciclo" style="font-weight: 700">
								...
								<option value="2025-2026">2025-2026</option>
											...
											<th class="text-center">
								<input type="text" name="txt_monto" size="20" placeholder="Monto"></th>
											<th class="text-center">
	...
	?>
						<tr>
							...
							<td width="16%" bgcolor="#FF9900" style="border-style: solid; border-width: 0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center">
							<font color="#0000FF"><?php echo $id_poliza; ?></font></td>

							<td width="29%" bgcolor="#FF9900" style="border-style: solid; border-width: 0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center">
