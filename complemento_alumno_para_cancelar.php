...
<table border="1" width="90%">
									...
									<thead>
										...
										<tr>
											...
											Alumno(a): <?php echo $nombre_com; ?></th>
											</tr>

										<tr>
										
										<form action="proc_cancelar_colegiatura.php" method="POST">
							...
							<select id="txt_mes" name="txt_mes" style="font-weight: 700">
...
</select><select id="txt_ciclo" name="txt_ciclo" style="font-weight: 700">
...
<button type="submit" class="btn btn-success btn-raised btn-xs"><i class="zmdi zmdi-refresh"></i>Cancelar</button>
</form>
</font></span></th> 
											</tr>
										<tr>
