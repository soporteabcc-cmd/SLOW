    ...
    <form action="proc_nuevo_alumno.php" method="POST">
		<table border="0" width="90%" bgcolor="#BD2130">
			...
			<tr>
				...
				<p align="center"><img border="0" src="images/fondo_alumnos.jpg" width="206" height="208"><form method="POST" enctype="multipart/form-data" action="--WEBBOT-SELF--">
					<p align="left">&nbsp;</p>
					<p align="left"></p>
				</form>
				</td>
			...
			<tr>
				...
				<td>&nbsp;</td>
				<td>
				<p align="center"><font color="#FFFFFF">Venta de Uniformes y 
				Utiles Escolares</font></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td align="right" bgcolor="#FFCC66"><font color="#000080">Nombre 
				Completo:</font></td>
				<td bgcolor="#FFCC66">
							<input name="txt_Apaterno" size="45" style="float: left"></td>
				<td align="right"><font color="#FFFFFF">Producto:</font></td>
				<td bgcolor="#FFCC66">
			...
			<tr>
				...
				<td align="right"><font color="#FFFFFF">Modo de Pago:</font></td>
				<td bgcolor="#FFCC66">
			...
			<tr>
				...
				<td align="right"><font color="#FFFFFF">Monto:</font></td>
				<td bgcolor="#FFCC66">
