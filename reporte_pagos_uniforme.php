...
$query_busqueda_alumno = "SELECT * FROM ventas_alumnos WHERE fecha_pago BETWEEN '".$fecha_inicial."' AND '".$fecha_final."'";
...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
			...
			<form action="reporte_pagos_uniforme.php" method="POST">
									<thead>
										<tr>
						...
						<input type="date" name="txt_fec_ini" size="15"></th>
											<th class="text-center"></th>
						...
						<input type="date" name="txt_fec_fin" size="15"></span></th>
										...
										<tr>
											...
											<th class="text-center" width="45%">Poliza</th>
										</tr>
									</thead>
					</form>
									<tbody>
						...
						<tr>
							...
							<font color="#0000FF"><?php echo $monto; ?></font></td>
								...
								<td width="45%" bgcolor="#FF9900" style="border-style: solid; border-width: 0; padding-left: 4px; padding-right: 4px; padding-top: 1px; padding-bottom: 1px" align="center">
									<font color="#0000FF"><?php echo $poliza; ?></font>
								</td>
