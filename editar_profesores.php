...
$query_busqueda_alumno = "SELECT * FROM `maestros_lowry` WHERE nombre_completo LIKE '%".$buscar_alumnos."%';";
...
<body>
	...
	?>
						...
						<tr>
							...
							<form action="caratula_editar_maestro.php" method="POST">
								<td>
									<input type="hidden" value=<?php echo $ID; ?> name="txt_busqueda_maestros" size="22" />
