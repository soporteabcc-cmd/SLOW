...
$query_busqueda_alumno = "SELECT * FROM `inventario_lowry` WHERE descripcion LIKE '%".$buscar_alumnos."%';";
...
<body>
                        ...
                        <div class="bg-white" style="padding: 30px;">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									<thead>
										<tr>
										<form action="agregar_exitencia.php" method="POST">
											<th class="text-center" colspan="4">
												<input type="text" name="txt_busqueda_alumnos" size="40" placeholder="Descripcion del producto" style="font-family: Arial; font-size: 14pt; font-weight: bold" >
	...
	?>
						...
						<tr>
							...
							<form action="caratula_agregar_existencia.php" method="POST">
								<td>
									<input type="hidden" value=<?php echo $ID; ?> name="txt_busqueda_alumnos" size="22" />
									<button type="submit" class="btn btn-success btn-raised btn-xs"><i class="zmdi zmdi-refresh"></i>Seleccionar...</button>
								</td>
							</form>
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="nuevo_producto.php" method="POST">
										...
										<button type="submit" class="btn btn-success btn-raised btn-xs"><a>
										<font color="#FFFFFF">Nuevo Producto</font></a></button>
