...
$query_busqueda_alumno = "SELECT * FROM `alumnos` WHERE NombreCom LIKE '%".$buscar_alumnos."%' or Nombre LIKE '%".$buscar_alumnos."%' OR Apaterno LIKE '%".$buscar_alumnos."%' or Amaterno LIKE '%".$buscar_alumnos."%';";
...
<body>
	...
	?>
						...
						<tr>
							...
							<form action="complemento_alumno.php" method="POST">
								<td>
						...
						<?php } ?>
                                ...
                                &nbsp;<div class="blog-date">
                                    <h6 class="font-weight-bold mb-n1">Nov</h6>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="crear_alumnos.php" method="POST">
