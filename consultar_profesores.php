...
$buscar_profesores = $_POST['txt_busqueda_profesores'];

$query_busqueda_profesores = "SELECT * FROM `maestros_lowry` WHERE nombre_completo LIKE '%".$buscar_profesores."%';";
?>
...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									<thead>
										<tr>
										<form action="consultar_profesores.php" method="POST">
											<th class="text-center" colspan="4">
												<input type="text" name="txt_busqueda_profesores" size="40" style="font-family: Arial; font-size: 14pt; font-weight: bold" >
			...
			<?php	require('conexion.php'); $resultado=$mysqli->query($query_busqueda_profesores); ?>
	...
	?>
						...
						<tr>
							...
							<font color="#0000FF"><?php echo $fecha_nac; ?></font></td>
							...
							<form action="complemento_maestro.php" method="POST">
								<td>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="crear_profesores.php" method="POST">
