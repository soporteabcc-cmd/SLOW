...
$query_busqueda_alumno = "SELECT * FROM `alumnos` WHERE NombreCom LIKE '%".$buscar_alumnos."%';";
								...
								<table class="table table-hover text-center">
									<thead>
										...
										<form action="ventas.php" method="POST">
											...
											<span>Crear Venta</span><p>&nbsp;<input type="text" name="txt_busqueda_alumnos" size="40" placeholder="Ingresar Nombre" style="font-family: Arial; font-size: 14pt; font-weight: bold" >
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="agregar_exitencia.php" method="POST">
										...
										<button type="submit" class="btn btn-success btn-raised btn-xs"><a>
										<font color="#FFFFFF">Agregar Existencia</font></a></button>
										<input type="hidden" value=<?php echo "@"; ?> name="txt_busqueda_alumnos" size="22" />
