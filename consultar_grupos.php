<?php
	...
	$buscar_periodos = $_POST['txt_periodo'];

$query_busqueda_periodos = "SELECT Nivel,periodo,Generacion,Cupo FROM `grupos` WHERE periodo='".$buscar_periodos."' AND Activo='1';";
...
<body>
    ...
    <div class="container-fluid py-5">
        <div class="container py-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									<thead>
										<tr>
										<form action="consultar_grupos.php" method="POST">
											<th class="text-center" colspan="4">
												<span style="background-color: #FF8000">
												<select id="miCombobox2" name="txt_periodo" style="font-weight: 700">
										...
										<tr>
											...
											<th class="text-center">Mostrar mas...</th>
										</tr>
									</thead>
									<tbody>
			...
			<?php	require('conexion.php'); $resultado=$mysqli->query($query_busqueda_periodos); ?>
	...
	?>
						...
						<tr>
							...
							<font color="#0000FF"><?php echo $nivel; ?></font></td>
							...
							<font color="#0000FF"><?php echo $gen; ?></font></td>
							...
							<font color="#0000FF"><?php echo $ocupado; ?></font></td>

							<form action="complemento_grupo.php" method="POST">
								<td>
									<input type="hidden" value=<?php echo $periodo; ?> name="txt_periodo" size="22" />
									<button type="submit" class="btn btn-success btn-raised btn-xs"><i class="zmdi zmdi-refresh"></i>Mas</button>
								</td>
							</form>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="crear_grupos.php" method="POST">
