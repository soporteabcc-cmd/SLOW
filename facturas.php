    ...
    <div class="container-fluid position-relative nav-bar p-0">
        <div class="container-lg position-relative p-0 px-lg-3" style="z-index: 9;">
            <nav class="navbar navbar-expand-lg bg-light navbar-light shadow-lg py-3 py-lg-0 pl-3 pl-lg-5">
                ...
                <h3><font color="#FFC107">Facturas</font></h3>
...
<table border="0" width="100%">
	...
	<tr>
		<td>
		<p align="center">
		<img border="0" src="images/facturas.png" width="225" height="225"></td>
	</tr>
	</table>
                    ...
                    <div class="mb-5">
                        ...
                        <div class="bg-white" style="padding: 30px;">
                            <ul class="list-inline m-0">
                                ...
                                <form action="consultar_facturas.php" method="POST">
									<td>
                                ...
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                              <form action="editar_facturas.php" method="POST">
                                ...
                                <form action="crear_facturas.php" method="POST">
