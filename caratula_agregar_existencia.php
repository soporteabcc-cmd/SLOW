...
$query_busqueda_alumno = "SELECT * FROM `inventario_lowry` WHERE id_producto='".$buscar_alumnos."';";
...
<body>
    ...
    <div class="container-fluid py-5">
						...
						<tr>
							...
							&nbsp;<p><u><font size="5" color="#343A40">Capturar 
							Datos de Producto:</font></u></td>
    ...
    <div align="center">
    <form action="proc_aumetar_existencia.php" method="POST">
		<table border="0" width="90%" bgcolor="#BD2130">
			...
			<tr>
				...
				<p align="right"><font color="#000080">Descripcion:</font></td>
				<td bgcolor="#FFCC66" colspan="3">
				<font size="5" color="#000080"><?php echo $descripcion; ?></font></td>
				<td align="right" rowspan="2">
				<p align="center">                                     
                                    <a class="text-dark">
	                                    <span class="badge badge-primary badge-pill">
				<img src="images/facturas.svg" width="158" height="158"></span></a></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td align="right" bgcolor="#FFCC66"><font color="#000080">
				Existencia Actual</font></td>
				<td bgcolor="#FFCC66"><font size="5" color="#000080"><?php echo $existencia; ?></font></td>
				<td bgcolor="#FFCC66">
							<p align="right"><font color="#000080">
				Aumentar Existencia:</font></td>
				<td bgcolor="#FFCC66">
							<input name="txt_aumento" size="17" style="float: left"></td>
				<td>&nbsp;</td>
			</tr>
			<tr>
				<td>&nbsp;</td>
				<td align="right" colspan="5" rowspan="3">
					<p align="center">
