                        ...
                        <div class="bg-white" style="padding: 30px;">
							...
							<div class="table-responsive">
								<table class="table table-hover text-center">
									<thead>
										<tr>
										<form action="insc_alumno_grupo.php" method="POST">
...
<form action="caratula_inscribir_alumno_en_grupo.php" method="POST">
						<tr>
							...
							<font color="#0000FF"><?php echo $nombre; ?></font></td>
								...
								<td>
									<input type="hidden" value=<?php echo $ID; ?> name="txt_id" size="22" />
									
									<button type="submit" class="btn btn-success btn-raised btn-xs"><i class="zmdi zmdi-refresh"></i>Inscribir</button>
								</td>
