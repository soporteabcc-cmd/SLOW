...
<table border="0" width="100%">
	...
	<tr>
		<td>
		<p align="center">
		<img border="0" src="images/grupos.jpg" width="391" height="290"></td>
	</tr>
	</table>
                            ...
                            <ul class="list-inline m-0">
                                ...
                                <form action="consultar_grupos.php" method="POST">
									<td>
										...
										<input type="hidden" value=@ name="txt_periodo" size="22" />
									</td>
								</form>
                                ...
                                <li class="mb-3 d-flex justify-content-between align-items-center">
                              <form action="editar_grupos.php" method="POST">

										<button type="submit" class="btn btn-success btn-raised btn-xs"><a>EDICION</a></button>
										<input type="hidden" value=@ name="txt_busqueda_alumnos" size="22" />
